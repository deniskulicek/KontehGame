...
SceneGame = game.Scene.extend({
    ...
    init: function() {
        ...
        this.addParallax(350, 'media/parallax1.png', -10);
        this.addParallax(620, 'media/parallax2.png', -50);

        this.addParallax(715, 'media/bushes.png', -120);
        this.addParallax(600, 'media/parallax3.png', -180);
